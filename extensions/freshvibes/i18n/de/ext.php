...
return array(
	'FreshVibesView' => array(
		...
		'apply_to_all_feeds' => 'Auf alle Feeds anwenden',
		'apply_to_all_tabs' => 'Auf alle Tabs anwenden',
		...
		'new_feed_position' => 'Position für neue Feeds',
		'new_feed_position_help' => 'Wählen Sie, wo neue Feeds im Tab erscheinen sollen',
		'new_feed_position_bottom' => 'Unten (auf Spalten verteilt)',
		'new_feed_position_top' => 'Oben in der ersten Spalte',
		'csrf_error' => 'Ungültiger Sicherheitstoken. Bitte laden Sie die Seite neu und versuchen Sie es erneut.',
		'error_invalid_request' => 'Ungültige Anfrage.',
		'error_operation_not_allowed' => 'Dieser Vorgang ist in diesem Modus nicht zulässig.',
		'error_delete_last_tab' => 'Der letzte Tab kann nicht gelöscht werden.',
		'error_tab_name_empty' => 'Der Tab-Name darf nicht leer sein.',
		'error_invalid_tab_order' => 'Ungültige Tab-Reihenfolge angegeben.',
		'error_unknown_tab_operation' => 'Unbekannter Tab-Vorgang.',
		'error_server' => 'Ein interner Serverfehler ist aufgetreten.',
		'error_loading_entries_logs' => 'Fehler beim Laden der Einträge für Feed %d. Bitte die Systemprotokolle prüfen.',
	),
);
