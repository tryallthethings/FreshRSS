...
return array(
	...
	'extensions' => array(
		...
		'install_failed' => '%s installation failed',
		'install_failed_rate_limited_generic' => 'Installation of %s failed due to rate limiting. Please try again later.',
		'installed' => '%s has been installed successfully',
		...
		'removed' => '%s removed',
		'update_all' => array(
			'failed_list' => 'Failed extensions: %s',
			'none' => 'All extensions are up to date',
			'ok' => '%d extensions updated successfully',
			'partial' => '%d extensions updated, %d failed',
		),
		'update_failed' => '%s update failed',
		'updated' => '%s has been updated successfully',
	),
	'import_export' => array(
